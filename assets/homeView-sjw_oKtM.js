import{s as i,a as m}from"./contactView-mA1KbyEE.js";import{c}from"./card-CFnKj6y6.js";import{D as l}from"./progress-cMOO8TMa.js";import{_ as d,c as g,a,b as p,r as e,o as h}from"./index-D3yRDfeE.js";const k={data(){return{image:i}},components:{aboutMe:m,card:c,Drawer:l},methods:{getCardText(){return`Hej!
...
Jag hoppas att du finner något intressant här och tveka inte att kontakta mig om du vill veta mer eller bara säga hej!`}}},f={class:"background-color"},u={class:"container margin"};function b(t,_,v,j,r,o){const s=e("Drawer"),n=e("card");return h(),g("div",f,[a(s),p("div",u,[a(n,{image:r.image,name:o.getCardText(),title:"Linus Håkansson",class:"pre-formatted"},null,8,["image","name"])])])}const J=d(k,[["render",b]]);export{J as default};
